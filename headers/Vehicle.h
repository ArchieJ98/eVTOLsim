...
class Vehicle{
    public:
        ...
        double cruiseSpeed;         // Cruise speed of vehicle in miles per hour
        double battery_Capacity;     // Battery capacity in kilowatt-hours
        double timeTo_Charge;        // Time to fully charge the battery in hours
        ...
        Vehicle(std::string name, double cruiseSpeed, double battery_Capacity, double timeTo_Charge,
        double energy_PerMile, int passenger_Count, double fault_Probability);                             // Constructor to initialize vehicle properties
};
